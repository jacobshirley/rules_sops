...
# By default all these toolchains are registered by the sops_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:sops_toolchain",
    toolchain_type = "@rules_sops//sops:toolchain_type",
)
""".format(
            platform = platform,
